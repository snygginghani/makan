...
export default function MapLibreScene({
  ...
  // Keep the WebGL canvas matched to its container. On slower (LAN/mobile)
  // loads the map can initialise before layout settles, leaving a blank
  // canvas; a ResizeObserver + a couple of delayed ticks make it reliable.
  useEffect(() => {
  ...
  return (
    <Map
      ...
      mapStyle={maplibreStyle(theme, basemap)}
